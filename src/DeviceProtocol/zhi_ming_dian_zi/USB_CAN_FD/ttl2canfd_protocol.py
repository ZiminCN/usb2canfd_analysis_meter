...
class TTL2CANFDProtocol:
    ...
    def order_set_hardware_filter(
        self, filter_mode: bool, filter_id_1: bytes, filter_id_2: bytes
    ):
        pass
    ...
    def order_send_can_frame(
        self, is_can_fd: bool, is_can_fd_brs: bool, can_frame_format: bool
    ):
        pass
